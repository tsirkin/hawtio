...
var Httpd = (function(Httpd) {
   ...
   * run function
   */
  Httpd.module = angular.module('httpd_plugin', ['hawtioCore'])
   ...
   *     topLevelTabs array.
   */
  Httpd.module.run(function(workspace, viewRegistry, layoutFull) {
    ...
    viewRegistry["httpd_plugin"] = layoutFull;
    ...
    workspace.topLevelTabs.push({
      id: "httpd",
      content: "Httpd",
      title: "Httpd plugin loaded dynamically",
      isValid: function(workspace) { return true; },
      href: function() { return "#/httpd_plugin"; },
      isActive: function(workspace) { return workspace.isLinkActive("httpd_plugin"); }
   ...
   *
   */
  Httpd.HttpdController = function($scope, jolokia) {
...
hawtioPluginLoader.addModule(Httpd.pluginName);
